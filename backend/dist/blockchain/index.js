...
exports.sendVoteTransaction = sendVoteTransaction;
const ethers_1 = require("ethers");
async function sendVoteTransaction(userId, candidateId) {
    var _a;
    try {
        // Debug logging
        console.log('Environment variables:', {
            ...
            SIGNER_PRIVATE_KEY_LENGTH: (_a = process.env.SIGNER_PRIVATE_KEY) === null || _a === void 0 ? void 0 : _a.length
        });
        ...
        const provider = new ethers_1.ethers.JsonRpcProvider(process.env.GANACHE_RPC_URL || 'http://127.0.0.1:8545');
